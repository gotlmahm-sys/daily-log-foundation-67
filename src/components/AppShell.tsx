...
import { ClipboardList, DoorOpen, IdCard, LayoutDashboard, LogOut, NotebookPen, Settings as SettingsIcon, ShieldCheck, Ticket, Users } from "lucide-react";
...
const NAV: { to: string; label: string; icon: typeof Users; perm?: Permission }[] = [
  ...
  { to: "/settings", label: "الإعدادات", icon: SettingsIcon, perm: "settings.manage" },
];
